...
#define FPC_BMLITE_USART_RX_PORT             GPIOB
#define FPC_BMLITE_USART_RX_PIN              GPIO_PIN_7
#define FPC_BMLITE_USART_TX_PORT             GPIOB
#define FPC_BMLITE_USART_TX_PIN              GPIO_PIN_6
